...
<head>
  <!-- Cloudflare Web Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "3951490bfd414fa9aa21aa112269bd5c"}'></script><!-- End Cloudflare Web Analytics -->
    ...
    <meta content="Some fur's projects" property="og:description" />
...
<div class="container">
  ...
  <div class="main">
    ...
    <details>
      ...
      Want to know more about it? Join the newsletter on the right! Don't worry, I will not spam your or sell your email.</p>
    </details>
    </div>
    <div class="page_right">

      <a class="button" target="_blank" href="https://github.com/Juliasmatius/">My Github⠀</a>
      <a class="button" target="_blank" href="https://replit.com/@JuliJuli4">My Replit⠀</a>
      <a class="button" target="_blank" href="https://julimiro.itch.io/">My Itch.io</a>
    </div>
  </div>
</div>
